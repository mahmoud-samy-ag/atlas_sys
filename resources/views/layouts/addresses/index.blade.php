                ...
                <div class="col-12">
                    <div class="card card-outline card-success">
                        <div class="card-header">
                            <h3 class="card-title">addresses ({{$addresses->total()}}) </h3>
                            <!-- /.card-tools -->
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                                ...
                                                <div class="col-md-2">
                                                    @if (auth()->user()->hasRole('product_specialist'))
                                                        <div class="card-tools">
                                                            <a href="{{route('addresses.create')}}" class="btn btn-success w-100"><i class="fas fa-plus"></i> Create</a>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                                    ...
                                                    @foreach ($addresses as $address)
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                <a class="btn btn-primary btn-sm" href="{{ route('addresses.edit' , $address->id) }} "><i class="fa fa-edit"></i></a>
                                                            </td> 
                                                        </tr>
                                                    @endforeach
                                                </tbody>
