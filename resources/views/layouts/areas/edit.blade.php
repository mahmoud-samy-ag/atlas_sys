    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Edite Area</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                ...
                <div class="col-md-10">
                    ...
                    <div class="card card-info">
                        <div class="card-header">
                          <h3 class="card- text-center">Edit Area</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form class="form-horizontal" method="post" action="{{ route('areas.update' , $area->id)}}">
                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <input value="{{$area->name}}" name="name" type="name" class="form-control" id="inputEmail3" placeholder="Full Name">
                                    </div>
                                </div>
